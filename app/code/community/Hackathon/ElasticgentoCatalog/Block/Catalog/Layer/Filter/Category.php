 ...
 *
 */
class Hackathon_ElasticgentoCatalog_Block_Catalog_Layer_Filter_Category extends Mage_Catalog_Block_Layer_Filter_Abstract
{
    /**
     ...
     *
     * @return Hackathon_ElasticgentoCore_Block_Catalog_Layer_Filter_Category
     */
